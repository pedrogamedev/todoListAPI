...
public class TodoListController {
    ...
    public ResponseEntity<PagedModel<EntityModel<TodoItemResponse>>> getAllBlogPostsPaged(
            @PageableDefault(page = 0, size = 1, sort = "title", direction = Sort.Direction.ASC) Pageable pageable
    ) {
